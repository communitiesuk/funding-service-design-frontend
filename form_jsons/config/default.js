...
module.exports = {
   ...
   */
  safelist: ["funding-service-design-application-store-dev.london.cloudapps.digital", "funding-service-design-application-store-test.london.cloudapps.digital"], // Array of hostnames you want to accept when using a session callback. eg "gov.uk".
  ...
  serviceStartPage: "/help/terms-and-conditions",
  privacyPolicyUrl: "",
